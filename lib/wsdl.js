...
var WSDL = function(definition, uri, options, exheaders, exoptions) {
    var self = this,
        fromFunc;
...
WSDL.prototype._processNextInclude = function(includes, callback) {
    ...
    open_wsdl(includePath, null, self.exheaders, self.exoptions, function(err, wsdl) {
        if (err) {
            return callback(err);
        }
...
function open_wsdl(uri, options, exheaders, exoptions, callback) {
    ...
    if (!/^http/.test(uri)) {
        ...
        http.request(uri, null /* options */, function (err, response, definition) {
            if (err) {
                ...
                wsdl = new WSDL(definition, uri, options, exheaders, exoptions);
                wsdl.onReady(callback);
            }
            else {
